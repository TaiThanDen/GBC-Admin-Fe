...
const EditorPosts = ({ onClose }: EditorPostsProps) => {
  ...
  return (
    <div className="relative bg-gray-100 h-full w-auto p-4 overflow-auto">
      <h1 className="text-2xl font-bold p-4">Edit Blog Posts</h1>
      <div className="grid lg:grid-cols-4 sm:grid-cols-1 ">
        ...
        <div className="col-span-1 p-4 pt-13">
          <div className="bg-white p-4 rounded-lg shadow-md">
            <h2 className="text-lg font-semibold mb-4">Ảnh bìa bài viết</h2>
            <AddImgDropZone
